    ...
    return _c('div', { staticClass: 'wizard' }, [
        ...
        _vm._l(_vm.steps, function(step, index) {
          return _c(
            ...
            [
              ...
              _vm._v(' '),
              _c('span', { staticClass: 'wizard__step__label' }, [
      ...
      _c(
        ...
        [
          ...
          _vm._v(' '),
          _c('div', { staticClass: 'wizard__body__actions clearfix' }, [
            _vm.backEnabled
              ? _c(
                  'a',
                  {
                    staticClass: 'wizard__back pull-left',
                    on: {
                  ...
                  [
                    _c('i', { staticClass: 'vgw-icon vgw-prev' }),
                    _vm._v(' '),
                    _c('span', [_vm._v(_vm._s(_vm.previousStepLabel))])
                  ]
                )
              : _vm._e(),
            _vm._v(' '),
            _vm.currentStep != _vm.steps.length - 1
              ? _c(
                  'a',
                  {
                    staticClass: 'wizard__next pull-right',
                    class: {
                      disabled: _vm.options[_vm.currentStep].nextDisabled
                    },
                    on: {
                      click: function($event) {
                        _vm.goNext()
                  ...
                  [
                    _c('span', [_vm._v(_vm._s(_vm.nextStepLabel))]),
                    _vm._v(' '),
                    _c('i', { staticClass: 'vgw-icon vgw-next' })
                  ]
                )
              : _vm._e(),
            _vm._v(' '),
            _vm.currentStep == _vm.steps.length - 1
              ? _c(
                  'a',
                  {
                    staticClass: 'wizard__next pull-right final-step',
                    class: {
                      disabled: _vm.options[_vm.currentStep].nextDisabled
                    },
                    on: {
                  ...
                  [_vm._v(' ' + _vm._s(_vm.finalStepLabel) + ' ')]
                )
              : _vm._e()
          ])
        ]
  ...
  methods: {
    ...
    parseOptions: function parseOptions() {
      ...
      for (var i = 0; i < this.steps.length; i++) {
        this$1.options.push(
          this$1.steps[i].options ? this$1.steps[i].options : {}
        )
      }
    },
