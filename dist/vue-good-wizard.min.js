  ...
  var e = {
      render: function() {
        var t = this,
          e = t.$createElement,
          i = t._self._c || e
        return i('div', { staticClass: 'wizard' }, [
          i(
            'ul',
                ...
                'li',
                {
                  ...
                  class: {
                    active: t.isMobile
                      ? t.currentStep === a
                      : t.currentStep >= a,
                    'vgw-mobile': t.isMobile
                  },
                  style: t.wizardStepStyle
                },
                [
                  i('span', {
                    staticClass: 'wizard__step__line',
                    class: { 'vgw-mobile': t.isMobile }
                  }),
                  t._v(' '),
                  i('span', { staticClass: 'wizard__step__label' }, [
                    t._v(t._s(e.label))
                  ]),
                  t._v(' '),
                  i('span', { staticClass: 'wizard__step__indicator' })
                ]
              )
            })
          ),
          ...
          i(
            ...
            [
              i(
                'div',
                { key: t.currentSlot, staticClass: 'wizard__body__step' },
                [t._t(t.currentSlot)],
                2
              ),
              t._v(' '),
              i('div', { staticClass: 'wizard__body__actions clearfix' }, [
                t.backEnabled
                  ? i(
                      'a',
                      {
                      ...
                      [
                        i('i', { staticClass: 'vgw-icon vgw-prev' }),
                        t._v(' '),
                        i('span', [t._v(t._s(t.previousStepLabel))])
                      ]
                    )
                  : t._e(),
                t._v(' '),
                t.currentStep != t.steps.length - 1
                  ? i(
                      'a',
                      {
                        staticClass: 'wizard__next pull-right',
                        class: {
                          disabled: t.options[t.currentStep].nextDisabled
                        },
                        on: {
                          click: function(e) {
                            t.goNext()
                      ...
                      [
                        i('span', [t._v(t._s(t.nextStepLabel))]),
                        t._v(' '),
                        i('i', { staticClass: 'vgw-icon vgw-next' })
                      ]
                    )
                  : t._e(),
                t._v(' '),
      ...
      computed: {
        wizardStepStyle: function() {
          return this.isMobile
            ? { width: '100%' }
            : { width: 100 / this.steps.length + '%' }
        },
        mobileArrowPosition: function() {
          return 'calc(50% - 14px)'
        },
        arrowPosition: function() {
          if (this.isMobile) return this.mobileArrowPosition
          var t = 100 / this.steps.length,
            e = t * this.currentStep + t / 2
      ...
      methods: {
        ...
        parseOptions: function() {
          ...
          for (var t = 0; t < this.steps.length; t++)
            this.options.push(
              this.steps[t].options ? this.steps[t].options : {}
            )
        },
          ...
          console.log('handle resize'),
            ...
            (this.resizer = setTimeout(function() {
              console.log('resizing...'),
                (t.isMobile = t.$refs['wizard-body'].clientWidth < 620)
            }, 100))
        }
      },
      mounted: function() {
